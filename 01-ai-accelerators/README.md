...
- [Google Quantum AI](https://ai.google/research/teams/applied-science/quantum-ai/)
- [NASA Quantum Artificial Intelligence Laboratory (QuAIL)](https://ti.arc.nasa.gov/tech/dash/groups/physics/quail/)
- [usra](https://quantum.usra.edu/quantum-computing)
- [Google Quantum A.I. Lab Team](https://plus.google.com/+QuantumAILab)
- [Quantum_computing](https://en.wikipedia.org/wiki/Quantum_computing)  
- [Quantum_algorithm](https://en.wikipedia.org/wiki/Quantum_algorithm) 
- [List of companies involved in quantum computing or communication](https://en.wikipedia.org/wiki/List_of_companies_involved_in_quantum_computing_or_communication#cite_note-1)
- [List_of_quantum_processors](https://en.wikipedia.org/wiki/List_of_quantum_processors) 
-  [Quantum_Turing_machine](https://en.wikipedia.org/wiki/Quantum_Turing_machine) 
-  [D-Wave_Systems](https://en.wikipedia.org/wiki/D-Wave_Systems) 
- [Quantum_machine_learning](https://en.wikipedia.org/wiki/Quantum_machine_learning)
-  [quantum-machine-learning](https://github.com/krishnakumarsekar/awesome-quantum-machine-learning) 
-  [d-wave systems](https://www.dwavesys.com/resources/publications) 
-  [research.google.QuantumAI](https://research.google.com/pubs/QuantumAI.html) 
-  [quantum_algorithms tutorial](https://people.cs.umass.edu/~strubell/doc/quantum_tutorial.pdf) 
-  [eecs.berkeley.quantumalgorithms](https://people.eecs.berkeley.edu/~vazirani/algorithms/chap10.pdf) 
-  [arxiv](https://arxiv.org/abs/1511.04206) 
-  [ibm-q](https://www.research.ibm.com/ibm-q/learn/what-is-quantum-computing/) 
-  [qiskit](https://www.qiskit.org/)
- [A Quantum Algorithm Could Help Us Bring AI to Life](https://futurism.com/quantum-algorithm-ai/)
- [IBM’s Dario Gil says quantum computing promises to accelerate AI](https://www.technologyreview.com/s/610624/ibms-dario-gil-says-quantum-computing-promises-to-accelerate-ai/)
- [Quantum Computing and AI Tie the Knot](https://towardsdatascience.com/quantum-computing-and-ai-tie-the-knot-d4440267451b)
- [Job One for Quantum Computers: Boost Artificial Intelligence](https://www.quantamagazine.org/job-one-for-quantum-computers-boost-artificial-intelligence-20180129/)
...
- [New Quantum ML algorithm could revolutionise Quantum AI before it even begins](https://www.fanaticalfuturist.com/2018/05/new-quantum-ml-algorithm-could-revolutionise-quantum-ai-before-it-even-begins/)
- [How Quantum Computers Will Revolutionize Artificial Intelligence, Machine Learning And Big Data](https://www.forbes.com/sites/bernardmarr/2017/09/05/how-quantum-computers-will-revolutionize-artificial-intelligence-machine-learning-and-big-data/#47fea0d95609)
- [A Startup Uses Quantum Computing to Boost Machine Learning](https://www.technologyreview.com/s/609804/a-startup-uses-quantum-computing-to-boost-machine-learning/)
- [Quantum Computing: Private/Startup Companies](https://quantumcomputingreport.com/players/privatestartup/)
- [THE NEXT BIG THING: QUANTUM MACHINE LEARNING](https://www.rolandberger.com/en/Point-of-View/The-next-big-thing-Quantum-machine-learning.html)
- [World's first Quantum Machine Learning Start-up Program lives in Ontario](https://www.investinontario.com/success-stories/worlds-first-quantum-machine-learning-start-program-lives-ontario)
- [Is it Time for Quantum Computing Startups? Maybe](https://spectrum.ieee.org/view-from-the-valley/at-work/start-ups/is-it-time-for-quantum-computing-startups)
- [A Hybrid of Quantum Computing and Machine Learning Is Spawning New Ventures](https://spectrum.ieee.org/tech-talk/robotics/artificial-intelligence/kickstarting-the-quantum-startup-a-hybrid-of-quantum-computing-and-machine-learning-is-spawning-new-ventures)
- [What It Takes to Build a Quantum Computing Startup](https://www.nextplatform.com/2018/02/02/takes-build-quantum-computing-startup/)
- [IBM Collaborating With Top Startups to Accelerate Quantum Computing](https://www.ibm.com/blogs/research/2018/04/ibm-startups-accelerate-quantum/)
- [https://www.analyticsinsight.net/11-quantum-computing-startups-to-watch/](11-quantum-computing-startups-to-watch)
- [A Startup Is Using Quantum Computing to Advance Machine Learning](https://sanvada.com/2017/12/20/a-startup-is-using-quantum-computing-to-advance-machine-learning/)
- [WHAT CAN QUANTUM MACHINE LEARNING DO?](https://www.quantummachinelearning.org/blog)
- [Speeding Up Industry: 12 Early-Stage Quantum Computing Startups to Watch](https://www.cbinsights.com/research/quantum-computing-startups-early-stage/)
- [How Does a Quantum Computer Work? Quantum Computing Explained](https://www.youtube.com/watch?v=WXhZBnDd5WM)
- [Quantum Annealing and Computation: A Brief Documentary Note](https://arxiv.org/pdf/1310.1339.pdf)
- [Quantum computing for the determined](https://www.youtube.com/playlist?list=PL1826E60FD05B44E4)
- [Stanford: Quantum Computing](https://plato.stanford.edu/entries/qt-quantcomp/)
- [DD_lectures](http://www.quiprocone.org/Protected/DD_lectures.htm)
- [CES 2018: Intel's 49-Qubit Chip Shoots for Quantum Supremacy](https://spectrum.ieee.org/tech-talk/computing/hardware/intels-49qubit-chip-aims-for-quantum-supremacy)
